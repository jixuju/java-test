 ...
 * 控制单位时间窗口内请求数-滑窗模式
 */
public class UnitTimesSlidingWindow {
    /* 循环队列 */
    ...
    public UnitTimesSlidingWindow(int timeMillisPerSlice, int windowSize) {
    ...
    public static void main(String args[]){
        UnitTimesSlidingWindow slidingWindow = new UnitTimesSlidingWindow(2,5);
